...
| `mcp_serve.py` | 33KB | MCP 服务端入口 | ✅ 已注释 |
| `batch_runner.py` | 57KB | 批量任务运行器 | ✅ 已注释 |
| `mini_swe_runner.py` | 28KB | 软件工程运行器 | ✅ 已注释 |
...
| `hermes_state.py` | 256KB | 状态管理、SQLite 数据库 | ✅ 已注释 |
| `hermes_constants.py` | 38KB | 常量定义、路径解析 | ✅ 已注释 |
| `hermes_logging.py` | 24KB | 日志配置和管理 | ✅ 已注释 |
| `utils.py` | 20KB | 通用工具函数 | ✅ 已注释 |
| `trajectory_compressor.py` | 69KB | 轨迹压缩，用于训练数据 | ✅ 已注释 |
